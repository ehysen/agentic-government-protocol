      ...
      <div class="demo" data-demo data-channel="agent" aria-label="Interactive walkthrough: Maria applies for food assistance through an agent">
        ...
        <div class="demo__body">
          <div class="demo__chat">
            ...
            <div class="demo__device" data-device>
              <div class="demo__screen">
                <div class="demo__statusbar" aria-hidden="true"><span class="demo__statusbar-time">9:41</span><span class="demo__statusbar-glyphs"><i></i><i></i><i></i></span></div>

                <div class="demo__chrome demo__chrome--agent" aria-hidden="true">
                  <span class="demo__chrome-ava demo__chrome-ava--spark"><svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 2l1.8 5.6L19 9l-5.2 1.4L12 16l-1.8-5.6L5 9l5.2-1.4z"/></svg></span>
                  <span class="demo__chrome-title">AI assistant<small>Maria&rsquo;s own app</small></span>
                  <span class="demo__chrome-tag">Chat</span>
                </div>

                <div class="demo__chrome demo__chrome--app" aria-hidden="true">
                  <span class="demo__chrome-ava demo__chrome-ava--seal"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><path d="M12 2l8 3v6c0 4.5-3.2 7.6-8 9-4.8-1.4-8-4.5-8-9V5z" stroke-linejoin="round"/><path d="M9 12l2 2 4-4" stroke-linecap="round" stroke-linejoin="round"/></svg></span>
                  <span class="demo__chrome-title">MyGov Assistant<small>Official state app</small></span>
                  <span class="demo__chrome-tag">Verified</span>
                </div>

                <div class="demo__chrome demo__chrome--sms" aria-hidden="true">
                  <span class="demo__sms-back">&lsaquo;</span>
                  <span class="demo__chrome-ava demo__chrome-ava--sms">GA</span>
                  <span class="demo__chrome-title">1‑800‑GOVERNMENT<small>Text message &middot; SMS/MMS</small></span>
                </div>

                <div class="demo__chrome demo__chrome--phone" aria-hidden="true">
                  <span class="demo__call-ava"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><path d="M6 3h3l2 5-2 1.5a11 11 0 0 0 5 5L17 17l5 2v3a2 2 0 0 1-2 2A16 16 0 0 1 4 6 2 2 0 0 1 6 3z" stroke-linejoin="round"/></svg></span>
                  <span class="demo__chrome-title">1‑800‑GOVERNMENT<small>Voice agent &middot; on call</small></span>
                  <span class="demo__call-timer">00:14</span>
                  <span class="demo__wave" aria-hidden="true"><i></i><i></i><i></i><i></i><i></i><i></i><i></i></span>
                </div>

                <div class="demo__stream" data-stream>
